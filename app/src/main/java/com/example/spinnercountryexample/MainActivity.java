...
public class MainActivity extends AppCompatActivity {
    private ArrayList<CountryModel> goodModelArrayList;
                ...
                try {
                    ...
                    if (obj.optString("status").equals("true")) {
                        ...
                        for (int i = 0; i < dataArray.length(); i++) {
                            ...
                            CountryModel spinnerModel = new CountryModel();
                        ...
                        for (int i = 0; i < goodModelArrayList.size(); i++) {
                            CountryNames.add(goodModelArrayList.get(i).getName().toString());
                        }

                        ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>(MainActivity.this, simple_spinner_item, CountryNames);
